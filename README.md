...
For more, including the daily schedules and an overview of the resources available to you, please visit this repo's [wiki](https://git.generalassemb.ly/sei-nyc-supernovas/class-info/wiki), which you can also find by clicking on the above Wiki tab.
...
| ---------------------------------- | --------------- | ---------------- | --------------------- | --------------------------------------------------------------- |
| **Instructional Lead** Units 1 & 4 | David Whitlatch | @David Whitlatch | david.whitlatch@ga.co | [davidtwhitlatch](https://git.generalassemb.ly/davidtwhitlatch) |
